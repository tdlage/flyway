 ...
 */
public class InformixFunction extends Function {
    /**
     ...
     */
    public InformixFunction(JdbcTemplate jdbcTemplate, DbSupport dbSupport, Schema schema, String name, String... args) {
